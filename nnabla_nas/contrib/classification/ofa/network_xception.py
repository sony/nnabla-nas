...
from .elastic_modules import DynamicMBConvLayer, DynamicConvLayer, Dynamic_XceptionLayer
...
class SearchNet(MyNetwork):
    ...
    def __init__(self,
        ...
        # Second conv layer
        self.second_conv = ConvLayer(input_channel, second_conv_channel,
        ...
        for width, n_block, s in zip(width_list[2:], n_block_list,
                                                       stride_stages[2:]):
