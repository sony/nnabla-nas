...
class ChoiceBlock(Mo.Module):
    def __init__(self, in_channels, out_channels, is_reduced=False, affine=True):
        super().__init__()
...
class Cell(Mo.Module):
    ...
    def __init__(self, num_choices, multiplier, channels, reductions, affine=False):
        super().__init__()
